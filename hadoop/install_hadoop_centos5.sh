...
#Configuring hadoop
find conf -name core-site.xml | xargs sed -i '/<configuration/a\<property>
...
find conf -name hdfs-site.xml | xargs sed -i '/<configuration/a\<property>
...
find conf -name mapred-site.xml | xargs sed -i '/<configuration/a\<property>
        <name>mapred.job.tracker</name>
	<value>localhost:9001</value>
</property>'

sudo su - hadoop --session-command="echo \"export JAVA_HOME=$JAVA_HOME ; export HADOOP_OPTS=-Djava.net.preferIPv4Stack=true"\" >> conf/hadoop-env.sh
